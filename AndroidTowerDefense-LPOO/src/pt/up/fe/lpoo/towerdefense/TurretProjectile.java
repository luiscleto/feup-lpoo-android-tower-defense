...
/**
 * This class is the type of projectile fired by the TurretTower defense
...
public class TurretProjectile extends Projectile {
	...
	/**
	 * Constructor for the TurretProjectile class. Calls the superclass's constructor and sets the damage type
	 ...
	 */
	public TurretProjectile(int iniX, int iniY, int goalX, int goalY, int movementSpeed, int projectileDamage) {
	...
	public Image getCurrentImage() {
		return Assets.turretProjectile;
	}
